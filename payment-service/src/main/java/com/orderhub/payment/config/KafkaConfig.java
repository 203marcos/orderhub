...
public class KafkaConfig {
     ...
     * dropping it. Without this the default handler logs and moves on, so an OrderCreated
     * event that cannot be processed would leave its order waiting on a payment forever.
     *
    ...
    public DefaultErrorHandler kafkaErrorHandler(KafkaProperties properties, SslBundles sslBundles) {
        ...
        // KafkaTemplate as soon as any KafkaTemplate bean exists, breaking PaymentEventProducer.
